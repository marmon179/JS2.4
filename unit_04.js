...
function f4() {
    const val = document.querySelector(".i-4").checked
...
function f5() {
    const check = document.querySelector(".i-5")
...
function f7() {
    ...
    if (val.length >= 6) {
        out2.innerHTML = 1
    } else if (val.length < 6) out2.innerHTML = 0
}
...
function f8() {
    ...
    out.innerHTML =
        ...
        "<button class='b-81'>Click</button>"
...
function f81() {
    ...
    const value = document.querySelector(".i-81").value
    out.innerHTML = value
}
...
function f9() {
    const rad = document.querySelector(".r-9")
...
function f13() {
    ...
    const val = document.querySelector(".i-13").value
    out.innerHTML = val
}
...
function f14() {
    ...
    const val = document.querySelector(".t-14").value
    out.innerHTML = val
}
...
function f15() {
    ...
    const val1 = document.querySelector(".i-15").value
    document.querySelector(".t-15").value = val1
    out.innerHTML = val1
}
...
function f16() {
    ...
    const val = document.querySelector(".s-16").value
    out.innerHTML = val
...
function f17() {
    ...
    const val = document.querySelector(".s-17").value
    out.innerHTML = val
}
...
function f19() {
    const value1 = document.querySelector(".i-191").value
    const value2 = document.querySelector(".i-192").value
    document.querySelector(".out-19").innerHTML = `${value1} ${value2}`
}
